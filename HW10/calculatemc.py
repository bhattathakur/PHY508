#This program calcualtes <e> and X based on the Wolff single cluster algorithm Monete Carlo simulation and saves in a file.
...
for i in range(5):
    print("run\t",i+1)
    if i==0:output.write("{}\t{}\t{}\t{}\t{}\t{}\t{:}\n".format("L","beta","Neql","Nmcs","Nbin","X(wolff mc)","<e>(wolff mc)"))
    outfile='demo'+str(i)+'.dat' #stores the data from 1 run
